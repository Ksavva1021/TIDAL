# Example usage:
# python3 Draw/scripts/mssm_search/makeDatacards_mssm.py --config=Draw/scripts/mssm_search/config_plot.yaml
...
def create_shell_script(input_folder, output_folder, parameter_file, channel, era, method, category, variable, sel, script_path, blind=False, LO_DY=False, do_ss=False):
    shell_script = f"""
#!/bin/bash
        ...
        for scheme in schemes:
            ...
            for setting in settings:
                ...
                if args.batch:
                    ...
                    create_shell_script(input_folder, output_folder, parameter_file, channel, era, method, category, variable, sel, script_path, blind=blind, LO_DY=args.LO_DY, do_ss=args.do_ss)
                    ...
                    process = [
                        ...
                        "--var", variable,
                        "--bsm_search",
                        "--masses", "60,65,70,75,80,85,90,95,100,105,110,115,120,125,130,135,140,160,180,200,250,300,350,400,450,500,600,700,800,900,1000,1100,1200,1400,1600,1800,2000,2300,2600,2900,3200,3500",  # TODO: make sure it gets extension files
                        "--config", config_file,
                        "--sel", sel
                    #    "--do_ss"
                    ]
